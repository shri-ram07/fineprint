...
| Vulnerable dependencies | Locked dependencies (`uv.lock`), digest-pinned base and uv images, a pinned `pip-audit`, SHA-pinned CI actions, `pip-audit` on every push and weekly on a schedule |
